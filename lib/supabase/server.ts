 ...
 * and ONLY from trusted server-side code that has already checked the
 * caller's role.
 */
      ...
      cookies: {
        ...
        set(name: string, value: string, options: CookieOptions) {
          try {
            ...
            // middleware refreshing sessions (see proxy.ts).
          }
        },
 ...
 * bundle. Only use inside Route Handlers / Server Actions, after verifying
